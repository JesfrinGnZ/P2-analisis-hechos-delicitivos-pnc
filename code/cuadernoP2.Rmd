...
```{r}
#Pruebas
# La detención ocurrion en el área rural, el delito fue homicidio por arma de fuego y el detenido era mayor de edad.
...
#  predicción
resultado <- predict(arbol, anio_detencion1, type = "class")
print(resultado)


# La detención ocurrion en el área urbana, el delito fue juegos ilícitos y el detenido era mayor de edad.
...
#  predicción
resultado2 <- predict(arbol, anio_detencion2, type = "class")
print(resultado2)
...
#  predicción
resultado3 <- predict(arbol, anio_detencion3, type = "class")
print(resultado3)
...
El siguiente árbol de decisión toma como variables independendientes a delito_com(valores de 1 a 126) y con el fin de predecir el grupo de hora en que la víctima se vio afectada por un delito(
...
```{r}
#Pruebas
# Dado que el delito fue homicidio por arma de fuego y ocurrió entre  00:00 a 11:59 
grupo_h_ocu1 <- data.frame(
  delito_com = c(1)
)

#  predicción
resultado_h1 <- predict(arbol, grupo_h_ocu1, type = "class")
print(resultado_h1)


#Pruebas
# Dado que el delito fue secuestro y ocurrió entre 18:00 a 23:59
grupo_h_ocu1 <- data.frame(
  delito_com = c(15)
)

#  predicción
resultado_h2 <- predict(arbol, grupo_h_ocu1, type = "class")
print(resultado_h2)
...
#  predicción
resultado_edad1 <- predict(arbol, edad1, type = "class")
...
#  predicción
resultado_edad1 <- predict(arbol, edad2, type = "class")
print(resultado_edad1)
...
#  predicción
resultado_edad3 <- predict(arbol, edad3, type = "class")
...
#  predicción
resultado_s1 <- predict(arbol, sexo1, type = "class")
print(resultado_s1)
